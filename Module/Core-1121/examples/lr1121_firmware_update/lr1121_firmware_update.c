...
#elif defined(LR1121_TRANSCEIVER_0102)
#include "lr1121_transceiver_0102.h"
#elif defined(LR1121_TRANSCEIVER_0103)
#include "lr1121_transceiver_0103.h"
#elif defined(LR1121_MODEM_05020001)
                                                 ...
                                                 uint32_t fw_expected, const uint32_t *buffer, uint32_t length)
{
    ...
    DEV_GPIO_Mode(BUSY_GPIO_Port,((lr1121_t *)radio)->busy, GPIO_MODE_OUTPUT_PP);
    DEV_Digital_Write(BUSY_GPIO_Port,((lr1121_t *)radio)->busy, 0);
    lr11xx_system_reset(radio);

    DEV_Delay_ms(500 );
    DEV_GPIO_Mode(BUSY_GPIO_Port,((lr1121_t *)radio)->busy, GPIO_MODE_INPUT);
    DEV_Delay_ms(100 );
